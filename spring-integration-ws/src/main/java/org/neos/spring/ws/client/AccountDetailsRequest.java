...
@XmlRootElement(name = "AccountDetailsRequest", namespace = "http://neos.org/spring/ws/stub/account")
public class AccountDetailsRequest {

    @XmlElement(namespace = "http://neos.org/spring/ws/stub/account", required = true)
