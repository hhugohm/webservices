...
public abstract class WservicesCallbackHandler {
    ...
    public void receiveResultgetMessageService(
        service.ws.axis2.neos.org.WservicesStub.GetMessageServiceResponse result) {
    }
    ...
    public void receiveResultcelsiusToFarenheit(
        service.ws.axis2.neos.org.WservicesStub.CelsiusToFarenheitResponse result) {
    }
    ...
    public void receiveResultfarenheitToCelsius(
        service.ws.axis2.neos.org.WservicesStub.FarenheitToCelsiusResponse result) {
    }
    ...
    public void receiveResultfactorial(
        service.ws.axis2.neos.org.WservicesStub.FactorialResponse result) {
    }
